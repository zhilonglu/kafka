 ...
 * @LZL 20160920
 */
public class network_car_business_license {
...
//		int id;
		...
		String business_user_code="";
		String business_range_desc="";
		String business_license_key="";
		...
		String create_time="";
		String update_time="";
		output=province_regionalism_code+",'"+province_regionalism_name+"','"+business_user_id+"','"+business_user_name+"','"+business_user_code+"','"+business_range_desc+
				"','"+business_license_key+"','"+validity_begin_date+"','"+validity_end_date+"','"+certifying_authority_code+"','"+certifying_authority_name+"','"+approve_date+
				"','"+business_address+"','"+management_state+"','"+certificate_type+"','"+certificate_state+"','"+create_time+"','"+update_time+"');";
		return output;
	}
			...
			new Thread(new Runnable() {
				...
				public void run() {
					for(MessageAndMetadata<byte[], byte[]> mm : kafkaStream){
						...
						String sql = "INSERT INTO network_car_business_license(id,province_regionalism_code,province_regionalism_name,business_user_id,"
								+ "business_user_name,business_user_code,business_range_desc,business_license_key,validity_begin_date,validity_end_date,certifying_authority_code,"+
								"certifying_authority_name,approve_date,business_address,management_state,certificate_type,certificate_state,create_time,update_time) VALUES("+id+","+mysqlValue;
						try {
							stmt.execute(sql);
